...
export const STRINGS = {
  ...
  'about.lead': {
    ko: 'MONEY BOX는 한국을 방문하는 외국인 고객을 위한 환전·카드·여행 편의 서비스를 제공합니다. 환전 지점과 24시간 무인 환전기, 외국인 대상 카드, 여행 편의 서비스를 한곳에서 이용할 수 있어요.',
    en: 'MONEY BOX offers currency exchange, cards, and travel conveniences for international visitors to Korea. Branches, 24-hour self-service kiosks, cards for foreign visitors, and travel services — all in one place.',
  },
  // 주요 서비스
  ...
  'about.svc.branch.d': { ko: '전국 주요 지점에서 직원의 안내를 받아 환전하고 카드를 받을 수 있어요.', en: 'Exchange money and pick up a card with staff help at branches nationwide.' },
  'about.svc.kiosk.t': { ko: '무인 환전기', en: 'Self-service kiosks' },
  'about.svc.kiosk.d': { ko: '24시간 무인기에서 언제든 환전하고 카드를 발급받을 수 있어요.', en: 'Exchange money and get a card anytime at 24-hour kiosks.' },
  'about.svc.card.t': { ko: '외국인 대상 카드', en: 'Cards for foreign visitors' },
  'about.svc.card.d': { ko: '이름·가입 없이 쓰는 올인원 카드로 결제와 교통을 한 장에 담습니다.', en: 'An all-in-one card with no name or sign-up — payments and transit in one.' },
  ...
  'about.svc.note': {
    ko: '각 서비스는 서로 이어져 있어요. 환전한 금액을 그대로 카드에 담아, 지점이나 무인기에서 받아, 여행 내내 결제와 교통에 사용할 수 있습니다.',
    en: 'The services connect: load exchanged money onto your card, pick it up at a branch or kiosk, and use it for payments and transit throughout your trip.',
  },
  // 서비스 특징
  ...
  'about.feat.3.t': { ko: '환전과 카드 서비스', en: 'Exchange and cards together' },
  'about.feat.3.d': { ko: '환전과 카드 발급·충전을 한 번의 방문으로 끝낼 수 있어요.', en: 'Exchange money and get or top up a card in a single visit.' },
  ...
  'prepaid.title': { ko: '올인원 선불카드', en: 'All-in-One Prepaid Card' },
  'prepaid.lead': {
    ko: '이름을 적지 않고, 별도 가입도 필요 없는 선불카드예요. 한 지갑은 상점·식당에서 결제하고, 다른 지갑은 지하철 개찰구를 열고 버스 요금을 냅니다. 금액은 원하는 대로 나눠 담으세요.',
    en: 'A prepaid card with no name on it and no registration required. One wallet pays in shops and restaurants; the other opens subway gates and pays bus fares. You decide how much goes where.',
  },
  // 두 지갑
  'prepaid.wallets.h2': { ko: '카드 하나에 지갑 둘', en: 'One card, two wallets' },
  'prepaid.wallets.sub': {
    ko: '결제와 교통을 한 장에. 무인기에서 언제든 두 지갑 사이로 금액을 옮길 수 있어요.',
    en: 'Payments and transit in one card. Move money between the two wallets anytime at a kiosk.',
  },
  'prepaid.wallet.pay.t': { ko: '선불 · 결제 지갑', en: 'Prepaid · Payments wallet' },
  'prepaid.wallet.pay.d': { ko: '상점, 식당, 편의점 등 제휴 가맹점에서 사용합니다.', en: 'Shops, restaurants, convenience stores and other affiliated merchants.' },
  'prepaid.wallet.transit.t': { ko: '교통 지갑', en: 'Transit wallet' },
  'prepaid.wallet.transit.d': { ko: '버스, 지하철, 그리고 교통카드를 받는 편의점에서 사용합니다.', en: 'Bus, subway, and convenience stores that accept transit cards.' },
  // 카드 기본 정보
  'prepaid.basics.h2': { ko: '카드 기본 정보', en: 'Card basics' },
  'prepaid.basics.fee.k': { ko: '카드 발급 수수료', en: 'Card issue fee' },
  'prepaid.basics.fee.v': { ko: 'KRW 5,000 · 충전 금액과 별도', en: 'KRW 5,000, separate from what you load' },
  'prepaid.basics.max.k': { ko: '최대 잔액', en: 'Maximum balance' },
  'prepaid.basics.max.v': { ko: '지갑당 KRW 500,000', en: 'KRW 500,000 per wallet' },
  'prepaid.basics.name.k': { ko: '카드 명의', en: 'Name on card' },
  'prepaid.basics.name.v': { ko: '없음 — 이름 없는 무기명 카드, 충전 시 신분증 불필요', en: 'None — bearer card, no ID needed to top up' },
  'prepaid.basics.over.k': { ko: '한도 초과 시', en: 'Above the limit' },
  'prepaid.basics.over.v': { ko: '그 자리에서 원화(KRW) 현금으로 돌려드립니다', en: 'Handed back to you in KRW cash on the spot' },
  // 충전 방법
  'prepaid.topup.h2': { ko: '충전하는 방법', en: 'How to add money' },
  'prepaid.topup.both': { ko: '선불 · 교통 모두 가능', en: 'Prepaid & Transit' },
  'prepaid.topup.transitOnly': { ko: '교통 지갑만 가능', en: 'Transit wallet only' },
  'prepaid.topup.cash.k': { ko: '원화(KRW) 현금', en: 'KRW cash' },
  'prepaid.topup.fx.k': { ko: '외화 지폐 환전', en: 'Foreign banknotes, exchanged' },
  'prepaid.topup.pay.k': { ko: 'Alipay / WeChat Pay', en: 'Alipay / WeChat Pay' },
  'prepaid.topup.note': {
    ko: '수중에 원화가 없어도 괜찮아요. Alipay·WeChat Pay로 카드를 구매하고 교통 지갑을 채울 수 있어, 지폐 한 장 바꾸기 전에 바로 이동을 시작할 수 있어요.',
    en: 'No won in your pocket? Alipay and WeChat Pay can buy the card and fill the transit wallet, so you can be moving before you have changed a single note.',
  },
  // 어디에서 받나요
  'prepaid.where.h2': { ko: '어디에서 받나요', en: 'Where to get it' },
  'prepaid.where.kiosk.t': { ko: '무인기에서', en: 'At a kiosk' },
  'prepaid.where.kiosk.d': { ko: '기계가 그 자리에서 카드를 발급하고 충전해 줍니다. 화면에서 언어를 고르고 안내를 따라가세요.', en: 'The machine issues the card and loads it on the spot. Choose your language on screen and follow along.' },
  'prepaid.where.kiosk.f1': { ko: '24시간 운영', en: 'Open 24 hours' },
  'prepaid.where.kiosk.f2': { ko: '즉시 발급', en: 'Issued instantly' },
  'prepaid.where.kiosk.f3': { ko: '현금 · 외화 · Alipay · WeChat Pay 충전', en: 'Top up with cash, foreign notes, Alipay & WeChat Pay' },
  'prepaid.where.branch.t': { ko: '지점에서', en: 'At a branch' },
  'prepaid.where.branch.d': { ko: 'PAYCO 앱에서 카드를 구매한 뒤 창구에서 받아 가세요. 줄 서기 전에 휴대폰에서 모든 선택을 마칠 수 있어요.', en: 'Buy the card in the PAYCO app first, then collect it at the counter. Settle every choice on your own phone before you queue.' },
  'prepaid.where.branch.f1': { ko: '앱에서 구매 후 수령', en: 'Bought in the app, picked up in person' },
  'prepaid.where.branch.f2': { ko: '현금 · 외화 충전', en: 'Top up with cash or foreign notes' },
  'prepaid.where.branch.f3': { ko: '선불 잔액 환불', en: 'Prepaid balance refunds' },
  'prepaid.where.branch.f4': { ko: '운영 시간 09:00–22:00', en: 'Open 09:00–22:00' },
  'prepaid.where.note': {
    ko: '어느 쪽이든 한국어를 몰라도 괜찮아요. 무인기 화면과 지점 신청서 모두 한국어·영어·일본어·중국어(간체·번체)로 제공됩니다.',
    en: 'Either way, no Korean needed. Kiosk screens and the branch request form run in Korean, English, Japanese, and Chinese (Simplified & Traditional).',
  },
  'prepaid.cta.kiosk': { ko: '무인기 찾기', en: 'Find a kiosk' },
  'prepaid.cta.branch': { ko: '지점 찾기', en: 'Find a branch' },
  // FAQ
  'prepaid.faq.h2': { ko: '자주 묻는 질문', en: 'Frequently asked' },
  'prepaid.faq.q1': { ko: '한국 은행 계좌나 전화번호가 필요한가요?', en: 'Do I need a Korean bank account or phone number?' },
  'prepaid.faq.a1': { ko: '아니요. 이 카드는 이름이 없고 별도 가입이 필요 없습니다. 무인기에서는 한국 은행 계좌나 전화번호, 신분증 없이도 카드를 구매하고 충전할 수 있어요.', en: 'No. The card carries no name and needs no registration. At a kiosk you can buy it and top it up without a Korean bank account, phone number, or ID.' },
  'prepaid.faq.q2': { ko: '신분증이 필요한가요?', en: 'Do I need ID?' },
  'prepaid.faq.a2': { ko: '아니요. 이름 없는 무기명 카드라, 충전할 때 신분증이 필요하지 않습니다.', en: 'No. It is a bearer card with no name on it, and no ID is needed to top up.' },
  'prepaid.faq.q3': { ko: '한도보다 많이 충전하면 어떻게 되나요?', en: 'What if I load more than the limit?' },
  'prepaid.faq.a3': { ko: '각 지갑은 최대 KRW 500,000까지 담을 수 있습니다. 한도를 넘는 금액은 그 자리에서 원화(KRW) 현금으로 돌려드려요.', en: 'Each wallet holds up to KRW 500,000. Anything above that limit is handed back to you in KRW cash on the spot.' },
  'prepaid.faq.q4': { ko: '남은 잔액을 돌려받을 수 있나요?', en: 'Can I get the leftover balance back?' },
  'prepaid.faq.a4': { ko: '네, 지점에서 가능합니다. 지점에서는 선불 잔액을 환불해 드리며, 무인기에서는 환불이 되지 않습니다.', en: 'Yes — at a branch. Branches refund your prepaid balance; kiosks do not handle refunds.' },
