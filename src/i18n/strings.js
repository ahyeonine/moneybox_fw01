...
export const STRINGS = {
  ...
  's2.home.hero.d': {
    ko: '온라인으로 예약하고, 가까운 지점에서 여권만 보여주고 받아가세요. 결제는 현장에서, 다른 곳보다 평균 더 좋은 환율.',
    en: 'Reserve online, then just show your passport at a nearby branch to pick up. Pay on site — on average a better rate than elsewhere.',
  },
  ...
  's2.home.trust.rate': { ko: '더 좋은 환율', en: 'Better exchange rates' },
  ...
  's2.home.val1.t': { ko: '더 좋은 환율', en: 'Better exchange rates' },
  's2.home.val1.d': {
    ko: '다른 곳보다 평균 더 많이 받아요. 회원가입하면 수령 시 현장에서 우대 환율까지 받아볼 수 있어요.',
    en: 'On average more than elsewhere. Sign up and you can also get a preferential rate on site at pickup.',
  },
  ...
  's2v.sum.rate.coupon': {
    ko: '전광판 환율 (회원 우대 · 현장 적용)',
    en: 'Board rate (member perk · applied on site)',
  },
