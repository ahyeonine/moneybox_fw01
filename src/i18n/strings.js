...
export const STRINGS = {
  ...
  's2v.signup.passport.reading': { ko: '여권 인식 중…', en: 'Reading passport…' },
  's2v.signup.passport.done': { ko: '{file} · 인식 완료', en: '{file} · recognized' },
  's2v.signup.passport.hint': {
    ko: '여권 사진면을 스캔하면 영문 이름·생년월일이 자동 입력돼요. (프로토타입 — OCR 시뮬레이션)',
    en: 'Scan your passport page — name & date of birth auto-fill. (Prototype — simulated OCR)',
  },
  's2v.signup.ocr': { ko: '여권 자동 인식', en: 'From passport' },
  's2v.signup.name.ph': { ko: '여권 스캔 시 자동 입력', en: 'Auto-filled from passport scan' },
  's2v.signup.birth': { ko: '생년월일 (여권)', en: 'Date of birth (passport)' },
  's2v.signup.cta': { ko: '가입하고 최고가 보장 받기', en: 'Sign up & get the guarantee' },
  's2v.signup.skip': { ko: '보장 없이 예약 계속', en: 'Continue without the guarantee' },
