...
export const STRINGS = {
  ...
  'book.step7.bestrate.t': { ko: '환율 우대 안내', en: 'Rate benefit' },
  'book.step7.bestrate.d': {
    ko: '현재 환율로 안내해 드려요. 방문하시는 날 환율이 더 좋아지면, 그날의 더 나은 환율로 적용해 드립니다.',
    en: "We show you the current rate. If the rate improves by the day you visit, we'll apply that day's better rate.",
  },
  ...
  'lookup.resno': { ko: '예약번호', en: 'Reservation number' },
  ...
  'lookup.guest.hint': {
    ko: '예약 시 받은 예약번호·이메일로 조회하세요. 예: RSV-20260728-0001 / john@example.com',
  ...
  'op.tx.scan.sub': {
    ...
    en: 'Scan a passport/ID to auto-find reservations with the same name & date of birth.',
  },
  'op.tx.scan.demoLabel': { ko: '데모: 스캔할 신분증 선택', en: 'Demo: pick an ID to scan' },
  'op.tx.scan.again': { ko: '다시 스캔', en: 'Rescan' },
  'op.tx.scan.matched': { ko: '일치하는 예약', en: 'Matching reservations' },
  'op.tx.scan.none': {
  ...
  'op.tx.bestRate.same': {
    ko: '예약환율이 여전히 더 유리하여 예약환율로 적용됩니다.',
    en: 'The reserved rate is still more favorable — it will be applied.',
  },
  // 수령일 환율 정산 (환율 미고정 예약)
  'op.tx.board.title': { ko: '수령일 환율 정산 (미고정)', en: 'Pickup-day settlement (no fixed rate)' },
  'op.tx.board.reservedNone': { ko: '예약 시 미고정 (수령일 환율)', en: 'Not fixed at booking (rate on pickup)' },
  'op.tx.board.settleOnPickup': { ko: '수령일 정산', en: 'Settled on pickup' },
  'op.tx.board.board': { ko: '수령일 환율', en: 'Rate on pickup day' },
  'op.tx.board.coupon': { ko: '쿠폰 우대', en: 'Coupon bonus' },
  'op.tx.board.note': {
    ko: '환율을 예약 시 고정하지 않았습니다. 수령일(오늘) 환율로 정산합니다.',
    en: 'No rate was fixed at booking. Settled at the rate on pickup day (today).',
  },
  'op.tx.board.couponNote': {
    ko: '쿠폰 보유 — 수령일 환율보다 우대해 정산합니다.',
    en: 'Coupon held — settled better than the pickup-day rate.',
  },
  ...
  'home.cmp.best': { ko: '더 많이 받아요', en: 'You get more' },
  ...
  's2.dir.label': { ko: '무엇을 바꾸시나요?', en: 'What are you exchanging?' },
  's2.dir.buy': { ko: '외화 → 원화', en: 'Foreign → KRW' },
  's2.dir.sell': { ko: '원화 → 외화', en: 'KRW → Foreign' },
  's2.dir.buy.hint': { ko: '외화를 내고 원화를 받아요. 받으실 외화 기준 금액을 입력하세요.', en: 'Hand over foreign cash, receive KRW. Enter the foreign-currency amount.' },
  's2.dir.sell.hint': { ko: '원화를 내고 외화를 받아요. 받으실 외화 금액을 입력하세요.', en: 'Pay in KRW, receive foreign cash. Enter the foreign-currency amount you want.' },
  ...
  's2.br.detail': { ko: '영업시간·전화·지도', en: 'Hours · phone · map' },
  's2.br.detail.hide': { ko: '상세 접기', en: 'Hide details' },
  's2.br.hours': { ko: '영업시간', en: 'Hours' },
  's2.br.phone': { ko: '전화', en: 'Phone' },
  ...
  's2.home.hero.eyebrow': { ko: '더 좋은 환율 · 여권만', en: 'Better rates · passport only' },
  's2.home.hero.t': {
    ko: '한국에서 간편한\n환전의 시작',
    en: 'A simple way to\nexchange money in Korea',
  },
  's2.home.hero.d': {
    ko: '온라인으로 예약하고 가까운 지점에서 여권만 보여주면 끝이에요. 전국 어디서나 가깝고, 환율도 좋아요.',
    en: 'Reserve online and just show your passport at a nearby branch. Always close by — with good rates, too.',
  },
  ...
  's2.home.trust.rate': { ko: '가까운 곳 어디서나', en: 'A branch always near you' },
  's2.home.trust.pay': { ko: '온라인 선결제 없음', en: 'No online payment' },
  's2.home.trust.branch': { ko: '전국 40+ 지점·공항', en: '40+ branches · airports' },
  's2.home.cmp.title': {
    ko: '다른 곳보다 환율이 이만큼 좋아요',
    en: 'Better rates than elsewhere — by this much',
  },
  's2.home.cmp.sub': {
  ...
  's2.home.cmp.other': { ko: '타 환전 채널', en: 'Other services' },
  's2.home.cmp.kiosk': { ko: '무인 키오스크', en: 'Kiosk' },
  's2.home.cmp.airport': { ko: '공항', en: 'Airport' },
  's2.home.cmp.more': { ko: '더 받아요', en: 'more' },
  's2.home.cmp.note': {
    ko: '※ 예시 비교 수치예요. 실제 차이는 통화·시점·지점에 따라 달라질 수 있어요.',
    en: '* Illustrative figures only. The actual difference varies by currency, time and branch.',
  },
  's2.home.val.title': { ko: '왜 머니박스인가요?', en: 'Why MoneyBox?' },
  's2.home.val1.t': { ko: '가까운 곳 어디서나', en: 'Always near you' },
  's2.home.val1.d': {
    ko: '명동·홍대·강남·공항 등 전국 40+ 지점. 환전이 필요할 때 내 주변에서 바로 받아요.',
    en: '40+ branches across Korea — Myeongdong, Hongdae, Gangnam, airports. Pick up right near you.',
  },
  's2.home.val2.t': { ko: '여권만, 환전은 현장에서', en: 'Passport only, exchange on site' },
  's2.home.val2.d': {
    ko: '온라인 선결제·본인인증 없이 예약하고, 지점에서 여권 확인 후 현금으로 환전합니다.',
    en: 'Book with no online payment or ID upload; show your passport and exchange in cash at the branch.',
  },
  ...
  's2v.rate.note': {
    ko: '환율은 예약 시 확정하지 않아요. 수령일 지점 환율이 적용됩니다.',
  ...
  's2v.more.line': {
    ...
    en: 'About {pct}% more on average than elsewhere',
  },
  's2v.coupon.badge': { ko: '회원 우대', en: 'Member perk' },
  's2v.coupon.applied': {
    ko: '회원 우대 — 수령 시 현장에서 우대 환율 적용',
    en: 'Member perk — preferential rate at pickup',
  },
  ...
  's2v.sum.rate.board': {
    ko: '수령일 환율',
    en: 'Rate on pickup day',
  },
  's2v.sum.rate.coupon': {
    ko: '수령일 환율 (회원 우대 · 현장 적용)',
    en: 'Pickup-day rate (member perk · applied on site)',
  },
  's2v.done.title': { ko: '예약이 완료됐어요!', en: 'Reservation confirmed!' },
  's2v.done.note': {
    ko: '수령일에 지점을 방문해 여권 확인 후 현금으로 환전하세요. 환율은 방문일(수령일) 기준으로 적용됩니다.',
  ...
  's2v.signup.d': {
    ko: '이름·이메일·비밀번호로 가입하면 회원 우대 대상이 돼요. 수령 시 현장 우대 환율에 더해 할인 쿠폰·환율 알림·회원 전용 서비스까지 받아보세요.',
    en: 'Sign up with your name, email and a password to get the member perk — a preferential rate on site at pickup, plus coupons, rate alerts and member-only services.',
  },
  's2v.signup.pw': { ko: '비밀번호', en: 'Password' },
  's2v.signup.pw.ph': { ko: '6자 이상', en: 'At least 6 characters' },
  's2v.signup.cta': { ko: '가입하고 회원 우대 받기', en: 'Sign up & get the perk' },
