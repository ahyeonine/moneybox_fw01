...
const DOC_REFS = [
  ...
  { route: '/site/book', screen: '외국인 웹사이트 V1 · 신청(STEP A~완료)', docs: [D.flow, D.data] },
  ...
  { route: '/cems/settings/rates', screen: 'CEMS · 환율관리', docs: [D.ia] },
  { route: '/cems/settings/limits', screen: 'CEMS · 한도관리', docs: [D.data] },
  { route: '/pos', screen: 'POS · 홈', docs: [D.ia] },
  { route: '/pos/reservation', screen: 'POS · 환전예약 검색/결과', docs: [D.flow] },
  { route: '/pos/transaction', screen: 'POS · 거래처리', docs: [D.state] },
