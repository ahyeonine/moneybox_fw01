...
export const POS_RESV_NOTES = [
  ...
  '취소·자동취소(CANCELLED) 건은 목록에서 제외됨. 방문예정확인(CONFIRMED) 건은 "방문확인만 보기"에도 노출',
  '검색 조건: 이름/이메일은 부분일치, 수령일은 "해당일 이후" 조건. 전화번호 없음(이메일 기반)',
  '결과 행 클릭 → 거래내용 확인 모달 → "확인" → 기존 환전예약플로우(플레이스홀더, /pos/reservation/flow)로 이동',
]
