    ...
    <div className="admin">
      <DevNote
        items={[
          ...
          '환전구분(매입/매출) 확인 후 처리',
          '거래완료 시 상태=완료로 전이(공유 store) → CEMS "외국인 환전예약관리"에도 즉시 반영. 완료·취소 건은 재처리 불가',
          '신분증 확인 체크 후에만 거래완료 버튼 활성화',
          '상단 시뮬레이션 바("하루 넘기기"·"자동취소 실행")로 시간 경과와 노쇼 자동취소를 재현 가능 (실제 스케줄러 대체)',
        ]}
      />
