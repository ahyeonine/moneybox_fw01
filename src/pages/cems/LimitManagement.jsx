    ...
    <div>
      <DevNote
        items={[
          ...
          '설정 가능한 최대금액 상한은 통화별 9,999 USD 상당액 — 초과 입력 시 저장/적용 차단 + 에러 표시 (실시간 환율 기준 USD 환산, 경계 반올림 오차 0.5% 허용)',
          '여기서 저장한 값은 외국인 웹사이트 STEP B 검증에 즉시 반영됨(공유 상태). 단, 최대금액을 낮춰도 기존 예약 레코드는 불변 — 신규 예약부터 적용',
          '저장/적용은 화면 상태(메모리)에만 반영되며 새로고침 시 초기화됨',
