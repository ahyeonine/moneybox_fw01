...
const DEV_NOTES = {
  ...
  info: [
    '필수 항목은 예약자명 + 이메일만. 로그인·회원가입·본인인증 없음, 메신저ID·휴대전화·생년월일·신분증 수집 안 함 (온라인 최소수집 원칙)',
    '이메일 OTP 인증 = 본인인증이 아니라 "입력한 이메일이 실제 수신 가능한 주소인지" 확인용 (예약/리마인더 안내 발송처 확보). 완료해야 다음 단계 진행 (데모: 인증번호를 배너로 표시, 5분 유효·30초 후 재발송·5회 오답 시 무효화)',
    '자세히: 04_데이터정의서.md',
  ],
  consent: [
